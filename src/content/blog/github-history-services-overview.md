---
title: "GitHub の歴史・無料提供の理由・現行サービス・Gist 完全ガイド"
date: 2026-05-05
...
| **GitHub Pages** | 静的サイトホスティング（**mdTechKnowledge も利用中**） |
...
### 4-4. 実例：mdTechKnowledge での使い分け

- **Repository + GitHub Pages**: mdTechKnowledge のような体系的な技術記事サイト
- **Gist**: note.com 記事の補足として置く設定スニペットや小さなサンプルコード、表データの単独配信

Gist は **note.com の記事中にも埋め込み可能** なので、技術記事の見せ方の選択肢として組み合わせる手もあります（mdTechKnowledge の表データはこの方式で note 記事に埋め込まれています）。
