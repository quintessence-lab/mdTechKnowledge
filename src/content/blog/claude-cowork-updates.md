...
| 日付 | 内容 |
|------|------|
| 6月5日（PT）/ 6月6日（JST） | **Cowork 5時間レート制限2倍キャンペーン開始（〜7月5日）** ― Anthropic の Boris Cherny（Claude Code 統括）がソーシャル投稿で告知（正式なニュースルーム記事は未公開）。**Cowork の5時間レート制限ウィンドウのみを2倍**に拡大する約1か月間の期間限定措置で、**週次の利用上限は変更なし**。対象は **Pro / Max / Team**（およびレガシー seat-based Enterprise）で、**無料プラン・従量制（usage-based）Enterprise は対象外**。 |
