...
### 契約の財務詳細（2026-05-20報道で判明）

2026年5月20日（PT）/ 2026年5月21日（JST）、AxiosおよびTechCrunchが新たに報じた財務詳細により、契約規模の全容が明らかになった。
...
| 年間総額 | **$15B / 年** |
| 契約期間 | **2029年5月まで（約3年）** |
| 想定総額 | xAI側に **$40B超** の収益見込み |
| 解約条件 | **いずれの当事者も90日通知で解約可能** |
| ramp-up期間 | 契約初月（2026年5月）と翌月（6月）は割引レートを適用 |
| Colossus 2 拡張 | **Colossus 2 への拡大が確定**、2026年6月中に **NVIDIA GB200 容量を順次追加** |
| 戦略的含意 | xAIの年間総収益が約$18Bとされる中、Anthropic1社で年間$15B（過半数規模）に達する大型契約 |

この契約は、Anthropicが「特定データセンターの全容量を競合（xAI）から長期賃借する」というAI業界では前例の少ないモデルを採用したものとして注目される。さらにColossus 2拡張により、GB200ベースの最新世代GPUへのアクセスも段階的に追加される。
