...
![Dynamic Workflows で 36 個のサブエージェントがすべて Fable 5 で起動している画面。ECONNRESET による失敗や idle が多発している](/mdTechKnowledge/images/cwc-tokyo-fable5-subagents-swarm.png)

*▲ 36 個のサブエージェントがすべて「Fable 5」で起動している様子。明示指定しないと、メインループのモデル（このとき Fable 5）がそのまま引き継がれる。*

> この一幕だけを取り上げた小話もあります: [恐怖のClaude 〜Dynamic Flows でサブエージェントがすべて Fable 5 で立ち上がったら](/mdTechKnowledge/blog/dynamic-workflows-fable5-runaway/)
