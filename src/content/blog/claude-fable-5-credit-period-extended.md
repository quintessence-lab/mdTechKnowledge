...
> **【2026-07-20 追記・最終決着】** 本記事は1回目の延長（7/12まで）時点の記録です。期限はその後 **7/19（PT）へ再延長**（→ [②](/mdTechKnowledge/blog/claude-fable-5-credit-period-extended-2/)）されたのち、**7月20日に最終決着**しました：**Max / Team Premium は週間上限50%として恒久的にプランへ組み込み**（追加費用なし）、**Pro / Team Standard は Usage Credits 継続＋一時 $100 クレジット付与**。本記事末尾で触れた「キャパシティが許せばサブスクへ戻す意向」は、Max/Team Premium については実現した形です。顛末は [③（完結編）](/mdTechKnowledge/blog/claude-fable-5-credit-period-final/) を参照。
...
- [これがラストチャンスかも②（7/19延長版）](/mdTechKnowledge/blog/claude-fable-5-credit-period-extended-2/) — 2度目の延長と GPT-5.6 Sol の影響（本稿の続き）
- [これがラストチャンスかも③（完結編）](/mdTechKnowledge/blog/claude-fable-5-credit-period-final/) — 7/20 の最終決着（Max/Team Premium 恒久組み込み・Pro は Usage Credits＋$100）
