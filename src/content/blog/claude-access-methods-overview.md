...
excerpt: "Claude を使う4つの主要な入り口（Claude Cowork / ブラウザ / Claude Code 端末 / Claude Code Web）について、アクセスURL・実行場所・対象ユーザー・適した用途を初心者向けに整理。2026/6/15からのインタラクティブ利用／プログラマティック利用の課金プール分離も解説。"
draft: false
---
