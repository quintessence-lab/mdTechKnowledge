...
## 3. 7 つのコネクタ統合＋拡張枠 — 主要 SaaS への接続

Claude for Small Business は以下の **7 つの SaaS コネクタ** を標準サポートし、業種別ビジネスアプリ向けの**拡張枠**が追加対応予定とされている。「あなたが支払っていることを忘れているサブスクリプション」を Claude 経由で統合的に操作できるようにする発想だ。
...
- **7コネクタ統合（＋業種別の拡張枠）**: QuickBooks / PayPal / HubSpot / Canva / DocuSign / Google Workspace / Microsoft 365
