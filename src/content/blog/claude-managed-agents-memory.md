...
| **モデルのweight変更** | なし（モデル自体は変更されない。蓄積された知識の活用による改善） |
...
- 2026-05-07、**Dreaming**（Research Preview）が発表。セッション間の自動パターン抽出・メモリ最適化でエージェントを自己改善させる機能。Harvey社で完了率約6倍の実績。モデルのweight変更なし
