---
title: "Anthropic 大型資本調達ラウンド — Amazon $5B/$100B AWSコミット・Google 最大$40B 投資の戦略的意義"
date: 2026-04-26
updatedDate: 2026-04-26
category: "一般リサーチ"
tags: ["Anthropic", "Amazon", "Google", "AWS", "GCP", "Trainium", "TPU", "投資", "クラウドインフラ", "Claude"]
excerpt: "2026年4月にAnthropicが立て続けに発表したAmazon・Googleからの巨額投資ラウンドを整理。Amazon追加$5B（累計$13B）+ 10年で$100B超のAWS支出コミット、Google最大$40B（初期$10B現金+条件付き$30B）と5年で5GWのTPU提供。マルチクラウド戦略・対OpenAI構図・Claudeスケーリングへの意味を網羅。"
draft: false
---
...
| クラウドパートナー | AWS中心 | AWS + GCP のデュアル体制 |
| TPU/Trainium割当 | 数百MW規模 | **10GW規模**を契約済み |
| 評価額 | $180B前後 | $350B〜$380B |
