...
category: "一般リサーチ"
tags: ["Anthropic", "Amazon", "Google", "AWS", "GCP", "Trainium", "TPU", "投資", "クラウドインフラ", "Claude", "Series G", "CoreWeave"]
excerpt: "2026年4月にAnthropicが立て続けに発表したAmazon・Googleからの巨額投資ラウンドと、Series G $380B評価額調達・年間収益ランレート $30B 突破（OpenAI 逆転）・CoreWeave との計算インフラ個別契約を整理。Amazon追加$5B（累計$13B）+ 10年で$100B超のAWS支出コミット、Google最大$40B、Series G $380B post-money、対OpenAI構図への影響を網羅。"
draft: false
---
