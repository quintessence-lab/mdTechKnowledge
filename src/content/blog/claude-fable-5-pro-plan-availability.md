...
excerpt: "2026年7月1日に輸出管理解除で全世界再開した Claude Fable 5 は、Pro プランでも使える。ただし『7月7日まで週間利用上限の最大50%まで追加費用なし → 7月8日以降は従量課金クレジットへ移行』という条件つきだ。本記事は Pro ユーザーの視点に絞り、プラン別の可否、そして『50%枠は既存週間上限からの切り出しで、Fable 5 が高コスト・重いモデルであるためすぐ尽きて課金圏に入りやすい』という点を仕組みから評価する。7月8日発効の本人確認（生体・政府ID）や再開時の新分類器も含め、Pro で使う際の注意点を整理する。"
draft: false
---
