...
excerpt: "Claude Managed Agentsの3層アーキテクチャ（Session/Harness/Sandbox）、p50 TTFT 60%削減のパフォーマンス改善、2026年4月23日パブリックベータ移行のMemory機能（全ユーザーに即時提供）、エンタープライズ向けRBAC・OpenTelemetry対応、料金体系（$0.08/session-hour）までを1ページに整理。"
draft: false
---
...
*本ガイドは2026年4月29日時点の情報に基づいています（2026-04-08 GA / 2026-04-09 Enterprise / 2026-04-23 Memory パブリックベータ移行 を反映）*
