...
`/effort` でスライダーを動かし、最右の **ultracode（xhigh + workflows）** を選ぶまでの操作を、短い動画で示します。

<iframe width="100%" style="aspect-ratio: 16 / 9;" src="https://www.youtube.com/embed/2bIInRbHcUw" title="Claude Code /effort で ultracode を選ぶ操作" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
## 5. Claude Sonnet 5 が新デフォルトに（2026-07-01 追記）

2026年6月30日（PT）に **Claude Sonnet 5** がリリースされ、**Claude Code・Free・Pro の新デフォルトモデル**になりました。effort 周りで押さえるべき変更は2点です。

- **Claude API でのデフォルト effort は `high`**。Sonnet 5 を API で使うと既定で高めの effort になるため、コスト重視なら明示的に下げる。
