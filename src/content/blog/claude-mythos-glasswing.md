...
- **Fable 5 は 2026年7月1日、全世界で再開**（Claude.ai / Claude Platform / Claude Code / Claude Cowork。サブスク内50%枠は当初7/7まで→**7/12→7/19（PT）へと2度延長**され、**7/20から Usage Credits（従量課金）へ移行**予定）。
