...
### 【2026-06-30 実施】Claude Mythos Preview が廃止（retire）—〔6/21時点の記録〕当時は「後継 Mythos 5 が停止中」という矛盾があった（→ 6/27・7/1 追記で解消）
...
- **Fable 5 は 2026年7月1日、全世界で再開**（Claude.ai / Claude Platform / Claude Code / Claude Cowork。サブスク内50%枠は当初7/7まで→**7/12→7/19（PT）へと2度延長**されたのち、**7/20に最終決着：Max / Team Premium は週間上限50%として恒久的にプランへ組み込み、Pro / Team Standard は Usage Credits（従量課金）継続＋一時$100クレジット**。詳細は[これがラストチャンスかも③（完結編）](/mdTechKnowledge/blog/claude-fable-5-credit-period-final/)参照）。
