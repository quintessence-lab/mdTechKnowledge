...
参考: 詳細記事 [MCP脆弱性レポート](/mdTechKnowledge/blog/mcp-vulnerability-report/)
...
- **重大脆弱性が公表（2026-04-16〜20、約20万サーバー影響）**: Anthropic は一部を "expected behavior" と判断。詳細は別記事 [MCP脆弱性レポート](/mdTechKnowledge/blog/mcp-vulnerability-report/) 参照
