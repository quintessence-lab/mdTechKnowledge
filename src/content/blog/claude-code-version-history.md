...
| バージョン | 主な機能追加 |
|-----------|------------|
| **2.1.263（2026-09-05 PT）** | バグ修正・安定性改善（**2.1.262はスキップ番号**） |
