...
### 13.4 【RC で明文化】キャッシュとルーティングの新仕様（最終仕様は 2026-07-28 公開予定）

公開済みの RC で、ステートレス化を実務で回すための2つの仕組みが明文化されました（§13冒頭のとおり RC は 2026-05-21 にロック済み。**2026-07-28 に公開されるのは最終仕様**です）。
