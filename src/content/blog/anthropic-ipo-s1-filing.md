...
> **【2026-07 追記】その後の成長ペース**: $47B run-rate は 2026-05-28 の Series H で言及された 5月中旬時点の数値です。報道では **1日あたり約 $96M（年換算）ペースで増加**しているとされ、アナリスト予測では **2026年末に $75B〜$90B** に達するとの見方もあります（いずれも報道・予測ベースで、S-1 で公表された確定値ではありません）。**同社幹部は「7月末までに年次収益ランレート $50B 超」を目標として言及した**と報じられていますが、確定値ではなく目標発言であり、S-1 で公表された数字ではない点に注意。
>
> **【2026-07 追記】IPO タイムラインの報道**: Fortune 等の報道では、**2026年9月に機関投資家向けロードショー、10月上場が濃厚**（OpenAI に先行の可能性）とされています。ただしこれらは**報道ベースの観測で、Anthropic 公式のスケジュール発表ではありません**。機密提出の段階では上場時期・市場・ティッカーはいずれも「未定（公式明言）」のままです（次節参照）。出典: [StartupHub: Anthropic Stock IPO](https://www.startuphub.ai/ai-news/ipo-watch/2026/anthropic-stock-ipo)。
...
### 収益性・主幹事をめぐる追加報道（2026-06-18 追記）

S-1 本体は依然非公開ですが、提出前後の報道で収益性と主幹事に関する材料が出ています。**いずれも S-1 開示ではなく報道・社内予測ベース**で、確定情報ではない点に注意してください。

- **初の営業黒字（社内予測）**: WSJ（2026-05-20）は、資金調達前に投資家へ共有された社内予測として、**Q2 2026 に営業利益 約 $559M / 四半期売上 約 $10.9B**（Q1 約 $4.8B から大幅増）を見込むと報じました。ただしこれは **営業利益（operating profit）であって純利益ではなく**、Anthropic 自身「データセンター投資で次四半期以降は赤字に戻りうる」と述べており、持続性には留保が要ります（会計手法も非公開）。
- **主幹事は「検討中」→「選定報道」へ**: Bloomberg（2026-06-03）は **Morgan Stanley と Goldman Sachs を主幹事に選定**と報道しました（二次媒体は JPMorgan を含む3行と報道）。ただし **当事者はいずれもノーコメント**で、正式発表ではありません。
- **$47B ランレートの読み方**: クラウドパートナー（AWS / Azure / Google Cloud）経由売上を**グロス計上**した数値とされ、ネット計上の競合と単純比較はできません。CFO は宣誓供述（2026-03-09）で「これまでの収益は $5B 超」と述べており、マーケ資料のランレートと実収益は区別して読む必要があります。

> 要するに、6/12 以降に「未確定」を覆す一次情報は出ていません。営業黒字（社内予測）も主幹事（報道）も S-1 開示ではないため、本記事の「公式発表に数字はない／未確定」というスタンスは維持されます。

### 評価額・上場時期・収益の続報（2026-06-27 追記・いずれも報道／推計ベース）

提出後も、評価額・時期・収益に関する**第三者の推計や報道**が続いています。**いずれも S-1 開示ではない**点を改めて強調します。

- **収益ランレート $47B**: 2026年5月に $47B を突破（Anthropic 公式告知）。2025年末の約 $9B から**約5倍**、前年同月比でも**約4〜5倍**という急成長（※前述のとおり、クラウド経由売上を**グロス計上**した数値で、ネット計上の競合とは単純比較不可）。
- **2026年10月 上場検討（報道）**: 2026年10月の Nasdaq 上場を狙うとの報道があり、予測市場は「10月31日までの上場確率 約69%」と織り込んでいます。ただし**公式には時期未確定**で、前述の「2027年3月・$560B」という後ろ倒し中央値（FutureSearch）とも併存します。
- **初日メジアン時価総額 $1.10T（推計）**: 調査機関 **FutureSearch** は上場初日のメジアン時価総額を **$1.10T** と推計（直近 Series H 評価額 **$965B** に対し約14%プレミアム。レンジは下振れ $750B〜上振れ $1.7T）。あくまで**第三者推計**で、確定値ではありません。

> 確定している公式値は、依然として **Series H（2026年5月28日・$65B 調達／ポストマネー $965B）** のみです。$47B・10月上場・$1.10T はいずれも報道・推計の域を出ません。

参考: [FutureSearch: Anthropic / OpenAI IPO dates & valuations](https://futuresearch.ai/anthropic-openai-ipo-dates-valuations/) ／ [SmartAsset: Anthropic IPO](https://smartasset.com/investing/anthropic-ipo) ／ [CNBC: Series H $965B](https://www.cnbc.com/2026/05/28/anthropic-open-ai-startup-value.html)

### 投資家向け事前説明会が開始（2026-07-15 追記・報道ベース）

2026年7月15日前後、主幹事候補の **Goldman Sachs・Morgan Stanley・JPMorgan Chase** が、機関投資家と Anthropic 経営陣を引き合わせる**投資家向け事前説明会（"testing the waters"）**の設定を進めていると報じられました。これは正式なロードショーの前段階として一般的な手続きで、**早ければ2026年10月の上場**を視野に入れた動きとされています。

> **依然として S-1 開示ではない**点に注意してください。事前説明会の実施自体は報道で確認できますが、上場時期・評価額・主幹事の正式確定はいずれも Anthropic 公式からの発表ではありません。SpaceX が2026年6月に大型 IPO を実施済みで、OpenAI は 2027年へ後ろ倒しと報じられている中、**Anthropic が2社の中間で先行する形**になる可能性があります。
...
### 【2026-07 追記】ガバナンス強化と、IPO 前に浮上した3件の法的リスク

**ガバナンス**: 2026年7月9日（PT）、**前 FRB 議長 Ben Bernanke 氏が Anthropic の Oversight Trust（Long-Term Benefit Trust）に参加**したと報じられました（CNBC 等）。上場を控え、独立性・信認の面で経営統治体制を補強する動きと受け止められています。

一方、IPO 投資家が**開示・係争リスクとして織り込む必要がある訴訟が3件**表面化しています（いずれも報道・提訴段階の主張であり、確定した事実ではありません）。

| 件名 | 内容（主張） | 相手方の反論・補足 |
|:---|:---|:---|
| **商標訴訟（対 Abnormal AI）** | Anthropic が 2026-07-01 に北カリフォルニア連邦地裁へ提訴。Abnormal の2025年リブランドが自社の**スラッシュ型ロゴ**を模倣し消費者混同を生むと主張、収益等の吐き出し（disgorgement）を請求 | Abnormal は「ロゴは**2021年4月に設計**（Anthropic の Claude 公開より前）」「創業は**2018年**で Anthropic より先」「年 $10M 超を支払う **Anthropic の顧客**」と反論（2026-07-07） |
| **Claude Max クラスアクション** | 原告 **Karl Kahn**。Max 20x を「Pro（$20/月）の**20倍**」と広告したが、実際は **6〜8倍**しか使えなかったと主張し、返金・損害賠償を請求（2025年4月以降の契約が対象） | — |
