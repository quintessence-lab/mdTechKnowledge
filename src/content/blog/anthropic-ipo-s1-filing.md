...
> **【2026-07 追記】その後の成長ペース**: $47B run-rate は 2026-05-28 の Series H で言及された 5月中旬時点の数値です。報道では **1日あたり約 $96M（年換算）ペースで増加**しているとされ、アナリスト予測では **2026年末に $75B〜$90B** に達するとの見方もあります（いずれも報道・予測ベースで、S-1 で公表された確定値ではありません）。なお「$50B 到達」を明示した公式発表は本記事執筆時点では確認できていません。
