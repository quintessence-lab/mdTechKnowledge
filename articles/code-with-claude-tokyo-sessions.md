...
emoji: "🗼"
type: "tech"
topics: ["claude", "claudecode", "ai", "anthropic", "イベント"]
published: true
canonical_url: "https://note.com/mdtechknowledge/n/nf921803c2112"
---
...
| # | 時間帯（頭出し） | セッション | 登壇者 |
|---|---|---|---|
| 1 | [0:00:00〜](https://www.youtube.com/watch?v=GiqyYQdYoIY&t=0s) | 基調講演① プラットフォーム & モデル | Katelyn Lesse / Dianne Penn（Anthropic） |
| 2 | [0:30:00〜](https://www.youtube.com/watch?v=GiqyYQdYoIY&t=1800s) | 基調講演② Claude Code | Cat Wu（Anthropic, Head of Product for Claude Code） |
| 3 | [1:17:20〜](https://www.youtube.com/watch?v=GiqyYQdYoIY&t=4640s) | Claude Code の新機能ディープダイブ | Anthropic（Claude Code プロダクトチーム） |
| 4 | [1:52:20〜](https://www.youtube.com/watch?v=GiqyYQdYoIY&t=6740s) | Inside Canva AI — 数千万ユーザー向けエージェント設計 | Danny Wu（Canva, Head of AI Products） |
| 5 | [2:44:20〜](https://www.youtube.com/watch?v=GiqyYQdYoIY&t=9860s) | Claude Managed Agents で本番投入を加速する | Michael Cohen / Jessica Yan（Anthropic） |
| 6 | [2:58:40〜](https://www.youtube.com/watch?v=GiqyYQdYoIY&t=10720s) | Fireside chat — Jessica Yan & Yusuke Kaji | Jessica Yan（Anthropic） / Yusuke Kaji（Rakuten） |
| 7 | [4:27:20〜](https://www.youtube.com/watch?v=GiqyYQdYoIY&t=16040s) | Rakuten's AI-nization — 自律化 × エンパワーメント | Yusuke Kaji（Rakuten） |
| 8 | [5:13:20〜](https://www.youtube.com/watch?v=GiqyYQdYoIY&t=18800s) | みずほにおけるAIネイティブな開発組織の構築 | 藤井 達人 / 染谷 謙太郎（みずほFG） |
| 9 | [6:02:40〜](https://www.youtube.com/watch?v=GiqyYQdYoIY&t=21760s) | フロンティアモデルの進化を引き出すエージェント設計 | Anthropic |
| 10 | [6:42:20〜](https://www.youtube.com/watch?v=GiqyYQdYoIY&t=24140s) | NRIの業務タスク・ベンチマークによるモデル選定 | 北村 雄騎（野村総合研究所） |
| 11 | [7:32:40〜](https://www.youtube.com/watch?v=GiqyYQdYoIY&t=27160s) | プロンプトキャッシングとコンテキスト・エンジニアリング | Anthropic |
| 12 | [8:14:20〜](https://www.youtube.com/watch?v=GiqyYQdYoIY&t=29660s) | ソフトウェア開発の民主化と、その先の未来 | 辻 順一郎（Junichiro Tsuji） |
...
> SF本会場の全体像は別記事 [Code with Claude 2026 開発者カンファレンス まとめ](https://note.com/mdtechknowledge/n/n1ac4b929c500) を参照してください。本記事は **東京会場のセッション構成** に絞っています。
...
**登壇者**: Katelyn Lesse / Dianne Penn（Anthropic） ｜ **頭出し**: [0:00:00〜](https://www.youtube.com/watch?v=GiqyYQdYoIY&t=0s)（動画 0:00–0:30）
...
**登壇者**: Cat Wu（Anthropic, Head of Product for Claude Code） ｜ **頭出し**: [0:30:00〜](https://www.youtube.com/watch?v=GiqyYQdYoIY&t=1800s)（動画 0:30–1:17）
...
**登壇者**: Anthropic（Claude Code プロダクトチーム） ｜ **頭出し**: [1:17:20〜](https://www.youtube.com/watch?v=GiqyYQdYoIY&t=4640s)（動画 1:17–1:52）
...
**登壇者**: Danny Wu（Canva, Head of AI Products） ｜ **頭出し**: [1:52:20〜](https://www.youtube.com/watch?v=GiqyYQdYoIY&t=6740s)（動画 1:52–2:44）
...
**登壇者**: Michael Cohen / Jessica Yan（Anthropic） ｜ **頭出し**: [2:44:20〜](https://www.youtube.com/watch?v=GiqyYQdYoIY&t=9860s)（動画 2:44–2:58）
...
**登壇者**: Jessica Yan（Anthropic） / Yusuke Kaji（Rakuten） ｜ **頭出し**: [2:58:40〜](https://www.youtube.com/watch?v=GiqyYQdYoIY&t=10720s)（動画 2:58–4:27）
...
**登壇者**: Yusuke Kaji（Rakuten） ｜ **頭出し**: [4:27:20〜](https://www.youtube.com/watch?v=GiqyYQdYoIY&t=16040s)（動画 4:27–5:13）
...
**登壇者**: 藤井 達人 / 染谷 謙太郎（みずほFG） ｜ **頭出し**: [5:13:20〜](https://www.youtube.com/watch?v=GiqyYQdYoIY&t=18800s)（動画 5:13–6:02）
...
**登壇者**: Anthropic ｜ **頭出し**: [6:02:40〜](https://www.youtube.com/watch?v=GiqyYQdYoIY&t=21760s)（動画 6:02–6:42）
...
**登壇者**: 北村 雄騎（野村総合研究所） ｜ **頭出し**: [6:42:20〜](https://www.youtube.com/watch?v=GiqyYQdYoIY&t=24140s)（動画 6:42–7:32）
...
**登壇者**: Anthropic ｜ **頭出し**: [7:32:40〜](https://www.youtube.com/watch?v=GiqyYQdYoIY&t=27160s)（動画 7:32–8:14）
...
**登壇者**: 辻 順一郎（Junichiro Tsuji） ｜ **頭出し**: [8:14:20〜](https://www.youtube.com/watch?v=GiqyYQdYoIY&t=29660s)（動画 8:14–8:37）
...
![Dynamic Workflows で 36 個のサブエージェントがすべて Fable 5 で起動している画面。ECONNRESET による失敗や idle が多発している](https://quintessence-lab.github.io/mdTechKnowledge/images/cwc-tokyo-fable5-subagents-swarm.png)

*▲ 36 個のサブエージェントがすべて「Fable 5」で起動している様子。明示指定しないと、メインループのモデル（このとき Fable 5）がそのまま引き継がれる。*

> この一幕だけを取り上げた小話もあります: [恐怖のClaude 〜Dynamic Flows でサブエージェントがすべて Fable 5 で立ち上がったら](https://note.com/mdtechknowledge/n/n1df38bc88335)
...
- [Code with Claude 2026 開発者カンファレンス まとめ](https://note.com/mdtechknowledge/n/n1ac4b929c500)（SF本会場の全体像）
- [Claude Fable 5 徹底解剖①概要編](https://note.com/mdtechknowledge/n/n5fdb0e2f02ad)（新モデル Fable 5 / Opus 4.8）
- [Claude Managed Agents 簡易ガイド](https://note.com/mdtechknowledge/n/n13473a66b658)（エージェント開発基盤）
- [Claude Code Routines 完全ガイド](https://note.com/mdtechknowledge/n/n340784f50b31)（定期実行ワークフロー）
- [Claude Code Dynamic Workflows ガイド](https://note.com/mdtechknowledge/n/ndacb07ee23fa)（マルチエージェント・オーケストレーション）
