...
emoji: "💸"
type: "idea"
topics: ["claude", "anthropic", "fable5", "料金", "ai"]
published: true
canonical_url: "https://note.com/mdtechknowledge/n/n4027232a27ca"
---
...
>
> 詳報は関連記事 [これがラストチャンスかも①（7/12まで延長）](https://quintessence-lab.github.io/mdTechKnowledge/blog/claude-fable-5-credit-period-extended/) ／ [これがラストチャンスかも②（7/19まで再延長・GPT-5.6 Sol の影響）](https://note.com/mdtechknowledge/n/na34cd05201a4) を参照。出典: [Claude 公式 @claudeai（7/18）](https://x.com/claudeai/status/2078302415804379218) ／ [TechTimes: Fable 5 Ends Subscription Limbo](https://www.techtimes.com/articles/320905/20260718/claude-fable-5-ends-subscription-limbo-permanent-max-credits-only-pro.htm)
...
- [Claude Fable 5 徹底解剖①（概要編）](https://note.com/mdtechknowledge/n/n5fdb0e2f02ad) — Fable 5 とは何か・料金・API 仕様・安全設計の全体像
- [米政府、Claude Fable 5 と Mythos 5 を停止](https://note.com/mdtechknowledge/n/ne35168eb8d13) — 停止〜7/1 再開までの全経緯
- [Claude Opus 4.8 完全ガイド](https://note.com/mdtechknowledge/n/nc9403cc20b1f) — Fable 5 のフォールバック先モデル
- [Anthropic Rate Limits API 完全ガイド](https://note.com/mdtechknowledge/n/nb103011f81ec) — レート制限（ティア）をプログラム照会する
